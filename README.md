...
This is the NOMAD Oasis distribution of IKZ-Berlin.
...
2. Clone the repository or download the repository as a zip file.
    ...
    ```sh
    git clone https://github.com/IKZ-Berlin/nomad-oasis-ikz.git
    cd nomad-oasis-ikz
    ```
    ...
    ```sh
    curl-L -o nomad-oasis-ikz.zip "https://github.com/IKZ-Berlin/nomad-oasis-ikz/archive/main.zip"
    unzip nomad-oasis-ikz.zip
    cd nomad-oasis-ikz
    ```
...
_I get an_ `Error response from daemon: Head "https://ghcr.io/v2/IKZ-Berlin/nomad-oasis-ikz/manifests/main": unauthorized`
